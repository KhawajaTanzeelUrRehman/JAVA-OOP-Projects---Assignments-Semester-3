...
public class EmployeeInfo extends JFrame implements ActionListener{
    ...
    EmployeeInfo(){
        ...
        headingLabel = new JLabel("ALL EMPLOYEE DETAILS");
        ...
        department.setBounds(400,80,70,20);
        add(department);
...
;
        ...
        try {
            ResultSet resultSet = databaseConnection.statement.executeQuery("select * from employee");
